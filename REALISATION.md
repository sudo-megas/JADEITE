...
- [ ] Tag `v1.1`, and `gh release create`. **The application is complete.** — The owner's to run: `gh` is not installed on the Windows machine, and the tag should be cut where the release is published from.
