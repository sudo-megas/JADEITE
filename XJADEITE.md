...
- The motto — *Built with Passion and Reason* — is the owner's own phrasing and is the same string in both catalogues, on the precedent of `common.brand`.
